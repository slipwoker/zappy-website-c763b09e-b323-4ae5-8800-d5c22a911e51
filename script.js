document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    var scrollTarget = elementTop - offset;
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('required') && value === '') {
      ...
      if ((type === 'tel' || name.indexOf('phone') !== -1 || name.indexOf('tel') !== -1) && value !== '') {
  ...
  function clearFormErrors(form) {
    var errorMessages = form.querySelectorAll('.form-error-message');
    errorMessages.forEach(function (el) { el.remove(); });

    var fields = form.querySelectorAll('.field-error, .field-success');
    fields.forEach(function (field) {
    ...
    var existingSuccess = form.querySelector('.form-success-message');
  ...
  function showFormSuccess(form) {
    ...
    successEl.textContent = form.getAttribute('data-success-message') || 'Your message has been sent successfully!';
  ...
  document.body.addEventListener('blur', function (e) {
    ...
    var existingError = form.querySelector('#' + ((field.id || field.name || 'field') + '-error'));
  ...
  function initScrollAnimations() {
    var candidates = document.querySelectorAll(
      ...
      '.slide-in, .zoom-in, [data-animate], ' +
      '.section, .card, .feature, .testimonial, .pricing-card, ' +
      '.hero-content, .about-content, .service-item, .team-member, ' +
      '.animate-on-scroll'
    );
  ...
  function refreshScrollAnimations() {
    if (animationObserver) {
      var newCandidates = document.querySelectorAll(
        '.fade-in:not(.animation-ready):not(.animated), ' +
        '.fade-up:not(.animation-ready):not(.animated), ' +
        '[data-animate]:not(.animation-ready):not(.animated), ' +
        '.animate-on-scroll:not(.animation-ready):not(.animated)'
      );
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'c763b09e-b323-4ae5-8800-d5c22a911e51',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'c763b09e-b323-4ae5-8800-d5c22a911e51';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 503456949 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c763b09e-b323-4ae5-8800-d5c22a911e51';
